...
package DateTime::Lite::TimeZone::OffsetOnly;
...
use base 'DateTime::Lite::TimeZone';
...
sub new {
    ...
    my $offset =
        DateTime::Lite::TimeZone::offset_as_seconds( $p{offset} );

    die "Invalid offset: $p{offset}\n" unless defined $offset;

    return DateTime::Lite::TimeZone::UTC->new unless $offset;

    my $self = { name   => DateTime::Lite::TimeZone::offset_as_string( $offset ),
                 offset => $offset,
               };
...
DateTime::Lite::TimeZone::OffsetOnly - A DateTime::Lite::TimeZone object that just contains an offset

=head1 SYNOPSIS

  my $offset_tz = DateTime::Lite::TimeZone->new( name => '-0300' );

=head1 DESCRIPTION

This class is used to provide the DateTime::Lite::TimeZone API needed by

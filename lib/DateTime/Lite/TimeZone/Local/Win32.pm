package DateTime::Lite::TimeZone::Local::Win32;
...

{
    ...
    sub FromRegistry
    {
        ...
        local $@;
        return eval { DateTime::Lite::TimeZone->load( name => $olson ) };
    }
}
...
DateTime::Lite::TimeZone::Local::Win32 - Determine the local system's time zone on Windows

=head1 SYNOPSIS

  my $tz = DateTime::Lite::TimeZone->load( name => 'local' );

# $Id: /mirror/coderepos/lang/perl/DateTime-Lite/trunk/lib/DateTime/Lite/LeapSecond.pm 92502 2008-11-24T14:19:18.555473Z daisuke  $

package DateTime::Lite::LeapSecond;
use strict;
...
sub _init {
    ...
    while (@_) {
        ...
        my $utc_epoch = DateTime::Lite::Util::ymd2rd( $year, ( $mon =~ /Jan/i ? 1 : 7 ), $mday );
...
DateTime::Lite::LeapSecond - leap seconds table and utilities
...
day.  It is used when DateTime::Lite.pm cannot compile the XS version of
this code.

...
DateTime::Lite::TimeZone::Catalog module, which contains a list of all the
...
DateTime::Lite::TimeZone::Catalog files will not be generated.
...
# DateTime::Lite::TimeZone module distribution in the tools/ directory
EOF
...
sub parse_file
{
    ...
    my $odb = DateTime::Lite::OlsonDB->new;
...
=head1
        $spans =~ s/-inf/DateTime::Lite::TimeZone::NEG_INFINITY/g;
        $spans =~ s/inf/DateTime::Lite::TimeZone::INFINITY/g;
...
EOF
        ...
        my $outdir = File::Spec->catdir( qw( lib DateTime Lite TimeZone ),
                                         @dir, @name_pieces  );
...
print "(should set to NEG_INF) ";
            $v = &DateTime::Lite::NEG_INFINITY;
        } elsif ($v eq 'inf') {
print "(should set to INF) ";
            $v = &DateTime::Lite::INFINITY;
        }
print "'$v'\n";
=cut
        $v
...
=head1
    ...
    $generator =~
      ...
      'name' => 'floating',
      'offset' => 0
    }, 'DateTime::Lite::TimeZone::Floating' )/;
    $generator =~
...
package DateTime::Lite::TimeZone::Catalog;
...
DateTime::Lite::TimeZone::Catalog - Provides a list of all valid time zone names

=head1 SYNOPSIS

See DateTime::Lite::TimeZone for API details.
...
EOF
    ...
    open my $fh, ">lib/DateTime/Lite/TimeZone/Catalog.pm" or die $!;

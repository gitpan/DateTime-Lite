...
my $t = DateTime::Lite->new( year => 1996, month => 11, day => 22,
...
$t = DateTime::Lite->new( year => 1986, month => 1, day => 28,
                    hour => 16, minute => 38,
                    time_zone => 'UTC' );
...
$t = DateTime::Lite->new( year => 2001, month => 4, day => 5,
                    hour => 16,
                    time_zone => 'UTC' );
...
# test sub months
$t = DateTime::Lite->new( year => 2001, month => 1, day => 31,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-02-01', 'february 1st' );

$t = DateTime::Lite->new( year => 2001, month => 2, day => 28,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-03-01', 'march 1st' );

$t = DateTime::Lite->new( year => 2001, month => 3, day => 31,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-04-01', 'april 1st' );

$t = DateTime::Lite->new( year => 2001, month => 4, day => 30,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-05-01', 'may 1st' );

$t = DateTime::Lite->new( year => 2001, month => 5, day => 31,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-06-01', 'june 1st' );

$t = DateTime::Lite->new( year => 2001, month => 6, day => 30,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-07-01', 'july 1st' );

$t = DateTime::Lite->new( year => 2001, month => 7, day => 31,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-08-01', 'august 1st' );

$t = DateTime::Lite->new( year => 2001, month => 8, day => 31,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-09-01', 'september 1st' );

$t = DateTime::Lite->new( year => 2001, month => 9, day => 30,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-10-01', 'october 1st' );

$t = DateTime::Lite->new( year => 2001, month => 10, day => 31,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-11-01', 'november 1st' );

$t = DateTime::Lite->new( year => 2001, month => 11, day => 30,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
is( $t->date, '2001-12-01', 'december 1st' );

$t = DateTime::Lite->new( year => 2001, month => 12, day => 31,
                    time_zone => 'UTC',
                  );
$t->add(days => 1);
...
$t = DateTime::Lite->new( year => 2001, month => 3, day => 28,
                    time_zone => 'UTC',
                  );
$t->add( years => 1 );
...
$t = DateTime::Lite->new( year => 2000, month => 2, day => 29,
                    time_zone => 'UTC',
                  );
$t->add( years => 1 );
...
$t = DateTime::Lite->new( year => 2000, month => 2, day => 28,
                    time_zone => 'UTC',
                  );
$t->add( years => 1 );
...
$t = DateTime::Lite->new( year => 2000, month => 3, day => 28,
                    time_zone => 'UTC',
                  );
$t->add( years => 1 );
...
# Test a bunch of years, before leap day
for (1..97) {
    $t = DateTime::Lite->new( year => 2002, month => 2, day => 28,
                        time_zone => 'UTC',
                      );
    $t->add( years => $_ );
...
# Test a bunch of years, after leap day
for (1..97) {
    $t = DateTime::Lite->new( year => 2002, month => 3, day => 28,
                        time_zone => 'UTC',
                      );
    $t->add( years => $_ );
    my $x = sprintf '%02d', $_ + 2;
...
# subtract years
for (1..97) {
    $t = DateTime::Lite->new( year => 1999, month => 3, day => 1,
                        time_zone => 'UTC',
                      );
    $t->add( years => -$_ );
...
$t = DateTime::Lite->new( year => 1997, month => 12, day => 1,
                    time_zone => 'UTC',
                  );
$t->add( months => 14 );
...
$t = DateTime::Lite->new( year => 1997, month => 1, day => 1,
                    time_zone => 'UTC',
                  );
$t->add( months => -1 );
is( $t->date, '1996-12-01', 'Subtracting months--rollover year' );

my $new = $t + DateTime::Lite::Duration->new( years => 2 );
is( $new->date, '1998-12-01', 'test + overloading' );

# test nanoseconds

{
    my $t = DateTime::Lite->new( year => 1997, month => 1, day => 1,
...
{
    my $dt = DateTime::Lite->new( year => 2003, month => 2, day => 28 );
...
{
    my $dt = DateTime::Lite->new( year => 2003, hour => 12, minute => 1);

...
{
    my $dt = DateTime::Lite->last_day_of_month( year  => 2001,
                                          month => $month,
                                          time_zone => 'UTC',
                                        );
...
foreach my $month (1..12)
{
    my $dt = DateTime::Lite->last_day_of_month( year  => 2004,
                                          month => $month,
                                          time_zone => 'UTC',
                                        );
...
{
    eval { DateTime::Lite->last_day_of_month( year => 2000, month => 1, nanosecond => 2000 ) };
    is( $@, '',

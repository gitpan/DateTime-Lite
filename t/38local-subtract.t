...
{
    my $dt1 = DateTime::Lite->new( year => 2003, month => 5, day => 6,
                             time_zone => 'America/Chicago',
                           );

    my $dt2 = DateTime::Lite->new( year => 2003, month => 11, day => 6,
                             time_zone => 'America/Chicago',
                           );
    ...
    is( DateTime::Lite->compare( $dt1->clone->add_duration($dur1), $dt2 ), 0,
        'subtract_datetime is reversible from start point' );
    is( DateTime::Lite->compare( $dt2->clone->subtract_duration($dur1), $dt1 ), 0,
    ...
    is( DateTime::Lite->compare( $dt1->clone->add_duration($dur3), $dt2 ), 0,
        'delta_md is reversible from start point' );
    is( DateTime::Lite->compare( $dt2->clone->subtract_duration($dur3), $dt1 ), 0,
    ...
    is( DateTime::Lite->compare( $dt2->clone->subtract_duration($dur4), $dt1 ), 0,
...
{
    my $dt1 = DateTime::Lite->new( year => 2003, month => 5, day => 6, hour => 18,
                             time_zone => 'America/Chicago',
                           );

    my $dt2 = DateTime::Lite->new( year => 2003, month => 11, day => 6, hour => 18,
                             time_zone => 'America/Chicago',
                           );
...
{
    my $dt1 = DateTime::Lite->new( year => 2003, month => 11, day => 6,
                             time_zone => 'America/Chicago',
                           );

    my $dt2 = DateTime::Lite->new( year => 2004, month => 5, day => 6,
                             time_zone => 'America/Chicago',
                           );
...
# the docs say use UTC to guarantee reversibility
{
    ...
    is( DateTime::Lite->compare( $dt1->add_duration($dur), $dt2 ), 0,
        'subtraction is reversible from start point with UTC' );
    is( DateTime::Lite->compare( $dt2->subtract_duration($dur), $dt2 ), 0,
        'subtraction is reversible from start point with UTC' );
}
...
# of subtraction done.
{
    ...
    is( DateTime::Lite->compare( $dt2->clone->add_duration($dur2), $dt1 ), 0,
        'subtraction is reversible' );
    is( DateTime::Lite->compare( $dt1->clone->subtract_duration($dur2), $dt2 ), 0,
        'subtraction is doubly reversible' );
}

{
    my $dt1 = DateTime::Lite->new( year => 2003, month => 4, day => 6,
                             hour => 1, minute => 58,
                             time_zone => "America/Chicago",
                           );

    my $dt2 = DateTime::Lite->new( year => 2003, month => 4, day => 6,
                             hour => 3, minute => 1,
                             time_zone => "America/Chicago",
                           );
    ...
    is( DateTime::Lite->compare( $dt1->clone->add_duration($dur), $dt2 ), 0,
        'subtraction is reversible' );
    is( DateTime::Lite->compare( $dt2->clone->subtract_duration($dur), $dt1), 0,
        'subtraction is doubly reversible' );
}

{
    my $dt1 = DateTime::Lite->new( year => 2003, month => 4, day => 5,
                             hour => 1, minute => 58,
                             time_zone => "America/Chicago",
                           );
    ...
    is( DateTime::Lite->compare( $dt2->clone->subtract_duration($dur),
                           $dt1->clone->add( hours => 1 ) ),
        0,
        'dt2 - dur != dt1 (not reversible)' );
    is( DateTime::Lite->compare( $dt2->clone->subtract_duration( $dur->clock_duration )
    ...
    is( DateTime::Lite->compare( $dt2->clone->add_duration( $dur2->clock_duration )
...
# they're the smaller operand
{
    ...
    my $dt2 = DateTime::Lite->new( year => 2003, month => 4, day => 7,
                             hour => 3, minute => 2,
                             time_zone => "America/Chicago",
                           );
...
{
    my $dt1 = DateTime::Lite->new( year => 2005, month => 8,
                             time_zone => 'Europe/London',
                           );

    my $dt2 = DateTime::Lite->new( year => 2005, month => 11,
                             time_zone => 'Europe/London',
                           );
...
{
    my $dt1 = DateTime::Lite->new( year => 2005, month => 8, hour => 12,
                             time_zone => 'Europe/London',
                           );

    my $dt2 = DateTime::Lite->new( year => 2005, month => 11, hour => 12,
                             time_zone => 'Europe/London',
                           );
...
{
    my $dt2 = DateTime::Lite->new( year => 2003, month => 10, day => 26,
                             hour => 1,
                             time_zone => 'America/Chicago',
                           );
...

{
    ...
    my $dt2 = DateTime::Lite->new( year => 2003, month => 5, day => 6,
                             time_zone => 'America/Chicago',
                           );
...
{
    my $dt1 = DateTime::Lite->new( year => 2005, month => 4, day => 3,
                             hour => 7, minute => 0,
                             time_zone => "America/New_York" );

    my $dt2 = DateTime::Lite->new( year => 2005, month => 4, day => 3,
                             hour => 8, minute => 0,
                             time_zone => "America/New_York" );

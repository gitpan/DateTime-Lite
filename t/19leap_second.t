...
# tests using UTC times
{
    ...
    my $t = DateTime::Lite->new( year => 1972, month => 6, day => 30,
    ...
    # subtract_datetime
    my $t2 = DateTime::Lite->new( year => 1972, month => 07, day => 1,
...

{
    ...
    my $t = DateTime::Lite->new( year => 1971, month => 12, day => 31,
                           hour => 23, minute => 58, second => 20,
                           time_zone => 'floating',
                         );
    my $t1 = $t->clone;
    ...
    my $t2 = DateTime::Lite->new( year => 1972, month => 1, day => 1,
                            hour => 0, minute => 0, second => 20,
                            time_zone => 'floating',
                          );
    my $dur = $t2->subtract_datetime_absolute($t1);
...
# test that we can set second to 60 (positive offset)
{
    eval
    {
        my $t = DateTime::Lite->new( year => 1972, month => 7, day => 1,
...
{
    my $dt = DateTime::Lite->new( year => 2003, time_zone => 'UTC' );

    is( $dt->leap_seconds, 22, 'datetime has 22 leap seconds' );
}

{
    my $dt = DateTime::Lite->new( year => 2003, time_zone => 'floating' );
...
{
    my $t = DateTime::Lite->new( year => 1972, month => 12, day => 31,
...
{
    eval { DateTime::Lite->new( year => 1972, month => 12, day => 31,
...
{
    my $dt1 = DateTime::Lite->new( year => 1998, month => 12, day => 31,
                             hour => 23,  minute => 59, second => 60,
                             time_zone => 'UTC',
                           );

    my $dt2 = DateTime::Lite->new( year => 1998, month => 12, day => 31,
...

{
    ...
    my $dt2 = DateTime::Lite->new( year => 1999, month => 1, day => 1,
...
{
    my $dt = DateTime::Lite->new( year => 1972, month => 6, day => 30,
                            hour => 23, minute => 58, second => 20,
                            time_zone => 'UTC',
                          );
...
{
    my $dt = DateTime::Lite->new( year => 1972, month => 7, day => 1,
...
{
    my $dt = DateTime::Lite->new( year => 1972, month => 7, day => 2,
                            hour => 23, minute => 58, second => 20,
                            time_zone => 'UTC',
                          );
...
{
    my $dt = DateTime::Lite->new( year => 1972, month => 7, day => 3,
                            hour => 2, minute => 58, second => 20,
                            time_zone => '+0300',
                          );
...
{
    my $dt = DateTime::Lite->new(year => 1997, month => 7, day => 1,
                           hour => 0, minute => 59, second => 59,
                           time_zone => '+0100');
...
{
    my $dt = DateTime::Lite->new(year => 1997, month => 6, day => 30,
...
{
    my $dt = DateTime::Lite->new(year => 2005, month => 12, day => 31,
                           hour => 23, minute => 59, second => 60,
                           time_zone => 'UTC');
...
{
    my $dt = DateTime::Lite->new( year => 2005, month => 12, day => 30,
...

{
    ...
    {
        my $dt = eval { DateTime::Lite->new( year   => $date->[0],
                                       month  => $date->[1],
                                       day    => $date->[2],
                                       hour   => 23,
                                       minute => 59,
        ...
        ok( $dt, "We can make a DateTime::Lite object for the leap second on $formatted" );
    }
}

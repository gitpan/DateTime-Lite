...

{
    ...
    my $dur = DateTime::Lite::Duration->new(%pairs);
...
}
{
    ...
    my $dur = DateTime::Lite::Duration->new( %pairs, end_of_month => 'limit' );
...
{
    my $dur = DateTime::Lite::Duration->new( days => 1, end_of_month => 'limit' );
    ok( $dur->is_limit_mode, "limit mode" );
}

{
    my $dur = DateTime::Lite::Duration->new( days => 1, end_of_month => 'preserve' );
    ok( $dur->is_preserve_mode, "preserve mode" );
}

my $leap_day = DateTime::Lite->new( year => 2004, month => 2, day => 29,
                              time_zone => 'UTC',
                            );

{
    my $new =
        $leap_day + DateTime::Lite::Duration->new( years => 1,
                                             end_of_month => 'wrap' );
...

{
    ...
    my $new2 =
        $leap_day + DateTime::Lite::Duration->new( months => 1,
                                             end_of_month => 'preserve' );
...
{
    my $inverse =
        DateTime::Lite::Duration->new( years => 1, months => 1,
                                 weeks => 1, days => 1,
...
{
    my $dur1 = DateTime::Lite::Duration->new( months => 6, days => 10 );

    my $dur2 = DateTime::Lite::Duration->new( months => 3, days => 7 );
...

{
    ...
    my $dur2 = DateTime::Lite::Duration->new( seconds => 1, nanoseconds => 500_000_000 );
...
{
    my $dur = DateTime::Lite::Duration->new( nanoseconds => -10 );
...
{
    my $dur = DateTime::Lite::Duration->new( days => 0 );
...
{
    eval { DateTime::Lite::Duration->new( months => 3 )->add( hours => -3 )->add( minutes => 1 ) };
    ok( ! $@, 'method chaining should work' );
}

{
    my $min_1  = DateTime::Lite::Duration->new( minutes => 1 );
    my $hour_1 = DateTime::Lite::Duration->new( hours => 1 );
...
{
    my $dur1 = DateTime::Lite::Duration->new( minutes => 10 );
    my $dur2 = DateTime::Lite::Duration->new( minutes => 20 );

    eval { my $x = 1 if $dur1 <=> $dur2 };
    like( $@, qr/does not overload comparison/,
          'check error for duration comparison overload' );

    is( DateTime::Lite::Duration->compare( $dur1, $dur2 ), -1,
        '20 minutes is greater than 10 minutes' );

    is( DateTime::Lite::Duration->compare( $dur1, $dur2, DateTime::Lite->new( year => 1 ) ), -1,
        '20 minutes is greater than 10 minutes' );
}


{
    my $dur1 = DateTime::Lite::Duration->new( days   => 29 );
    my $dur2 = DateTime::Lite::Duration->new( months => 1 );

    my $base = DateTime::Lite->new( year => 2004 );
    is( DateTime::Lite::Duration->compare( $dur1, $dur2, $base ), -1,
        '29 days is less than 1 month with base of 2004-01-01' );

    $base = DateTime::Lite->new( year => 2004, month => 2 );
    is( DateTime::Lite::Duration->compare( $dur1, $dur2, $base ), 0,
        '29 days is equal to 1 month with base of 2004-02-01' );

    $base = DateTime::Lite->new( year => 2005, month => 2 );
    is( DateTime::Lite::Duration->compare( $dur1, $dur2, $base ), 1,
        '29 days is greater than 1 month with base of 2005-02-01' );
}

{
    my $dur1 = DateTime::Lite::Duration->new( nanoseconds => 1_000,
                                        seconds     => 1,
                                      );
    ...
    my $dur4 = DateTime::Lite::Duration->new( seconds => -1,
...
{
    my $dur = DateTime::Lite::Duration->new( minutes => 30,
                                       seconds => -1,
                                     );
...
{
    my $dur = DateTime::Lite::Duration->new( minutes => 50 );
...
{
    local $TODO = 'reject fractional units in DateTime::Lite::Duration->new';

    eval { DateTime::Lite::Duration->new( minutes => 50.2 ) };

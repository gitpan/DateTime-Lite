...
my $d = DateTime::Lite->new( year => 2001,
                       month => 7,
                       day => 5,
                       hour => 2,
                       minute => 12,
...
my $leap_d = DateTime::Lite->new( year => 2004,
                            month => 7,
                            day => 5,
                            hour => 2,
                            minute => 12,
...
my $sunday = DateTime::Lite->new( year   => 2003,
                            month  => 1,
                            day    => 26,
                            time_zone => 'UTC',
                          );
...
my $monday = DateTime::Lite->new( year   => 2003,
                            month  => 1,
                            day    => 27,
                            time_zone => 'UTC',
                          );
...
{
    my $dt0 = DateTime::Lite->new( year => 1, time_zone => 'UTC' );
...
{
    my $dt = DateTime::Lite->new( year => 50, month => 2,
...
{
    my $dt = DateTime::Lite->new( year => 2000, month => 1, day => 5,
                            time_zone => 'UTC',
                          );
...
{
    my $dt = DateTime::Lite->new( year => 2000, month => 2, day => 29,
                            time_zone => 'UTC',
                          );
...
{
    my $dt = DateTime::Lite->new( year => -6, month => 2, day => 25,
                            time_zone => 'UTC',
                          );
...
{
    my $dt = DateTime::Lite->new( year => 1996, month => 2, day => 1 );
...
{
    my $dt = DateTime::Lite->new( year => 1996, month => 5, day => 1 );
...
{
    my $dt = DateTime::Lite->new( year => 1996, month => 8, day => 1 );
...
{
    my $dt = DateTime::Lite->new( year => 1996, month => 11, day => 1 );
...
{
    my $dt = DateTime::Lite->new( year => 1996, nanosecond => 500_000_000 );
...
{
    my $dt = DateTime::Lite->new( year => 2003, month => 5, day => 7 );
    is( $dt->weekday_of_month, 1, '->weekday_of_month' );
    is( $dt->week_of_month, 2, '->week_of_month' );
}

{
    my $dt = DateTime::Lite->new( year => 2003, month => 5, day => 8 );
    is( $dt->weekday_of_month, 2, '->weekday_of_month' );
    is( $dt->week_of_month, 2, '->week_of_month' );
}

{
    my $dt = DateTime::Lite->new( year => 1000, hour => 23 );
    is( $dt->hour,      23, '->hour' );
...
{
    my $dt = DateTime::Lite->new( year => 1000, hour => 0 );
    is( $dt->hour,       0, '->hour' );

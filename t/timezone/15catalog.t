...
{
    my @names = DateTime::Lite::TimeZone::names_in_category('America');
...
{
    my @zones = DateTime::Lite::TimeZone::names_in_country('jp');
...
{
    my @zones = DateTime::Lite::TimeZone->names_in_country('cl');
...
{
    my @zones = DateTime::Lite::TimeZone::names_in_country('us');

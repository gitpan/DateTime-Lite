...
foreach ( @offset_seconds ) {
    is( DateTime::Lite::TimeZone::offset_as_seconds(
            DateTime::Lite::TimeZone::offset_as_string( $_ )
        ),
...
foreach ( @offset_strings ) {
    is( DateTime::Lite::TimeZone::offset_as_string(
            DateTime::Lite::TimeZone::offset_as_seconds( $_ )
        ),
...
is( DateTime::Lite::TimeZone->offset_as_seconds('+0100'), 3600,
    'offset_as_seconds as class method' );

{
    DateTime::Lite::TimeZone::offset_as_string(3600);
...
{
    DateTime::Lite::TimeZone::offset_as_seconds("+0100");

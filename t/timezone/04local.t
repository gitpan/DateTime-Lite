...
use DateTime::Lite::TimeZone::Local::Unix;
...
my @aliases = sort keys %{ DateTime::Lite::TimeZone::links() };
...
DateTime::Lite::TimeZone::Local->_load_subclass();

{
    ...
    {
        local $ENV{TZ} = $alias;
        my $tz = eval { DateTime::Lite::TimeZone::Local->TimeZone() };
...

{
    ...
    my $tz = DateTime::Lite::TimeZone::Local::Unix->FromEnv();
    is( $tz, undef,
        'invalid time zone name in $ENV{TZ} fails' );

    local $ENV{TZ} = '123/456';

    $tz = DateTime::Lite::TimeZone::Local::Unix->FromEnv();
    is( $tz, undef,
        'invalid time zone name in $ENV{TZ} fails' );
}

{
    ...
    local $ENV{TZ} = 0;
    $tz = eval { DateTime::Lite::TimeZone::Local->TimeZone() };
    is( $tz->name(), 'UTC',
...

{
    ...
    DateTime::Lite::TimeZone::Local::Unix->FromEnv();
...
SKIP:
{
    ...
    local *DateTime::Lite::TimeZone::Local::Unix::_Readlink = sub { '/usr/share/zoneinfo/US/Eastern' };

    my $tz;
    eval { $tz = DateTime::Lite::TimeZone::Local::Unix->FromEtcLocaltime() };
    ...
    local *DateTime::Lite::TimeZone::Local::Unix::_Readlink = sub { '/usr/share/zoneinfo/Foo/Bar' };

    $tz = DateTime::Lite::TimeZone::Local::Unix->FromEtcLocaltime() ;
    is( $@, '', 'valid time zone name in /etc/localtime symlink should not leave $@ set' );
    ok( ! $tz, 'no time zone was found' );


    local *DateTime::Lite::TimeZone::Local::Unix::_Readlink = sub { undef };
    local *DateTime::Lite::TimeZone::Local::Unix::_FindMatchingZoneinfoFile = sub { 'America/Los_Angeles' };
...
SKIP:
{
    ...
    local *DateTime::Lite::TimeZone::Local::Unix::_ReadEtcSysconfigClock = sub { 'US/Eastern' };

    my $tz;
    eval { $tz = DateTime::Lite::TimeZone::Local::Unix->FromEtcSysconfigClock() };
...
SKIP:
{
    ...
    local *DateTime::Lite::TimeZone::Local::Unix::_ReadEtcDefaultInit = sub { 'Asia/Tokyo' };

    my $tz;
    eval { $tz = DateTime::Lite::TimeZone::Local::Unix->FromEtcDefaultInit() };
...
SKIP:
{
...

    {
        ...
        my $tz;
        eval { $tz = DateTime::Lite::TimeZone::Local->TimeZone() };
    ...
    {
        local *DateTime::Lite::TimeZone::Local::Unix::FromEtcLocaltime = sub { undef };
...

    {
        ...
        local *DateTime::Lite::TimeZone::Local::Unix::FromEtcLocaltime = sub { undef };
        local *DateTime::Lite::TimeZone::Local::Unix::FromEtcTimezone = sub { undef };
        local *DateTime::Lite::TimeZone::Local::Unix::FromEtcTIMEZONE = sub { undef };
...
SKIP:
{
    ...
    DateTime::Lite::TimeZone::Local::Unix->FromEtcTimezone();
...
SKIP:
{
...

    {
        ...
        $tz = DateTime::Lite::TimeZone::Local->TimeZone();
...

{
    ...
    my $tz = eval { DateTime::Lite::TimeZone->load( name => 'local' ) };
    is( $tz->name(), 'Australia/Melbourne',
...
SKIP:
{
    ...
    is( basename( DateTime::Lite::TimeZone::Local::Unix->_Readlink( $third ) ),
        basename( $first ),

...

{
    ...
    my $t1 = DateTime::Lite->from_epoch( epoch => 0 );
...
{
    my $dt = DateTime::Lite->from_epoch( epoch => '3600' );
...

{
    ...
    my $now = time;
    my $nowtest = DateTime::Lite->now();
    my $nowtest2 = DateTime::Lite->from_epoch( epoch => $now );
...
{
    my $epochtest = DateTime::Lite->from_epoch( epoch => '997121000' );
...

{
    ...
    my $dt = DateTime::Lite->new( year  => 1970,
                            month => 1,
                            day   => 1,
                            hour  => 0,
                            time_zone => '-0100',
...

{
    ...
    my $dt = DateTime::Lite->from_epoch( epoch => 0,
                                   time_zone => '-0100',
                                 );
...
# Adding/subtracting should affect epoch
{
    ...
    my $epochtest = DateTime::Lite->from_epoch( epoch => $expected  );
...
{
    my $dt = DateTime::Lite->from_epoch( epoch => 0.5 );
...
{
    my $dt = DateTime::Lite->from_epoch( epoch => 0.1234567891 );
...
SKIP:
{
    ...
    is( DateTime::Lite->new( year => 1904 )->epoch, -2082844800,
        "epoch should work back to at least 1904" );

    my $dt = DateTime::Lite->from_epoch( epoch => -2082844800 );

...
my $dt1 = DateTime::Lite->new( year => 1970, hour => 1, nanosecond => 100 );

my $dt2 = DateTime::Lite->from_object( object => $dt1 );
...
{
    my $t1 =
	DateTime::Lite::Calendar::_Test::WithoutTZ->new
	    ( rd_days => 1, rd_secs => 0 );

    # Tests creating objects from other calendars (without time zones)
    my $t2 = DateTime::Lite->from_object( object => $t1 );

    isa_ok( $t2, 'DateTime::Lite' );
...

{
    ...
    my $t1 =
	DateTime::Lite::Calendar::_Test::WithTZ->new
...
{
    my $tz = DateTime::Lite::TimeZone->load( name => 'UTC' );
    my $t1 =
	DateTime::Lite::Calendar::_Test::WithTZ->new
    ...
    isa_ok( $t2, 'DateTime::Lite' );
    is( $t2->second, 60, 'new DateTime::Lite from_object with TZ which is a leap second' );
}
...
package DateTime::Lite::Calendar::_Test::WithoutTZ;
...
package DateTime::Lite::Calendar::_Test::WithTZ;

...

{
    my @dt = ( DateTime::Lite->new( year => 1950,
               ...
               DateTime::Lite::Infinite::Past->new,
               DateTime::Lite::Infinite::Future->new,
             );
...
{
    my $dt1 = DateTime::Lite->now( locale => 'en_US' );
...
{
    my $has_ical = eval { require DateTime::Lite::Format::ICal; 1 };

 SKIP:
    {
        skip 'This test needs DateTime::Lite::Format::ICal', 1
            unless $has_ical;

        my $dt = DateTime::Lite->new( year      => 2004,
                                formatter => 'DateTime::Lite::Format::ICal',
                              );

...
{
    my $date1 = DateTime::Lite->new( year => 2001, month => 5, day => 10,
			       hour => 4, minute => 3, second => 2,
			       nanosecond => 12,
			       time_zone => 'UTC' );

    my $date2 = DateTime::Lite->new( year => 2001, month => 6, day => 12,
...

{
    ...
    my $new = $date1 - DateTime::Lite::Duration->new( years => 2 );
    is( $new->datetime, '1999-05-10T04:03:02', 'test - overloading' );
}

{
    my $d = DateTime::Lite->new( year => 2001, month => 10, day => 19,
...
{
    my $dt1 = DateTime::Lite->new( year => 2003, month => 2, day => 9,
                             hour => 0, minute => 0, second => 1,
                             time_zone => 'UTC',
                           );

    my $dt2 = DateTime::Lite->new( year => 2003, month => 2, day => 7,
    ...
    is( DateTime::Lite->compare($dt1, $dt3), 0,
...
{
    my $dt1 = DateTime::Lite->new( year => 2000, month => 1, day => 5,
                             hour => 0, minute => 10, second => 0,
                             nanosecond => 1,
                             time_zone => 'UTC',
                           );

    my $dt2 = DateTime::Lite->new( year => 2000, month => 1, day => 6,
                             hour => 0, minute => 10, second => 0,
                             nanosecond => 0,
                             time_zone => 'UTC',
                           );
...

{
    ...
    my $dt2 = DateTime::Lite->new( year => 2000, month => 1, day => 5,
                             hour => 0, minute => 10, second => 0,
                             nanosecond => 10,
                             time_zone => 'UTC',
                           );
...
{
    my $dt1 = DateTime::Lite->new( year => 2003, month => 12, day => 31 );
...
{
    my $date1  = DateTime::Lite->new( year => 2003, month =>  9, day => 30 );
    my $date2  = DateTime::Lite->new( year => 2003, month => 10, day =>  1 );

    my $date3  = DateTime::Lite->new( year => 2003, month => 10, day => 31 );
    my $date4  = DateTime::Lite->new( year => 2003, month => 11, day =>  1 );

    my $date5  = DateTime::Lite->new( year => 2003, month => 2, day => 28 );
    my $date6  = DateTime::Lite->new( year => 2003, month => 3, day =>  1 );

    my $date7 = DateTime::Lite->new( year => 2003, month => 1, day => 31 );
    my $date8 = DateTime::Lite->new( year => 2003, month => 2, day =>  1 );
...
{
    my $dt1 = DateTime::Lite->new( year => 2005, month => 6, day => 11,
                             time_zone => 'UTC',
                           );

    my $dt2 = DateTime::Lite->new( year => 2005, month => 11, day => 10,
                             time_zone => 'UTC',
                           );
